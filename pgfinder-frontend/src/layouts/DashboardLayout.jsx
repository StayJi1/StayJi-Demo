...
function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-900 pb-24 text-slate-100 lg:pb-0">
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[280px_1fr]">
        <Sidebar />
        <main className="min-w-0 overflow-x-hidden border-slate-800/80 bg-surface-800/70 p-3 sm:p-6 lg:border-l xl:p-10">
          {profileIncomplete ? (
