...
The Support card includes a clickable email and phone number. Click `hello.stayji@gmail.com` to open a mail app through `mailto:` or click `1234567899` to start a phone call on supported devices.
